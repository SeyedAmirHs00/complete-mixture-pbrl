...
from reward_model.mixture_mixup_reward_model import MixtureRewardModel
...
class Workspace(object):
    def __init__(self, cfg):
        ...
        import random
        cfg["seed"]=random.randint(1,1000)
        self.cfg = cfg
        self.logger = Logger(
            self.work_dir,
...
@hydra.main(config_path='config', config_name='train_PEBBLE_mixture_mixup', strict=True)
def main(cfg):
