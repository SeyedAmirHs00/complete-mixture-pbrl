...
from reward_model.mixture_reward_model_diagnostics import MixtureRewardModel
...
@hydra.main(config_path='config', config_name='train_PEBBLE_mixture_diagnostics', strict=True)
def main(cfg):
