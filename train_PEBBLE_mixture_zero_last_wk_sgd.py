...
detached w_k with frozen coef; trust path is unweighted with frozen reward
deltas.
"""
import numpy as np
import torch
...
from reward_model.mixture_reward_model_wk_sgd import MixtureRewardModel
...
class Workspace(object):
    def __init__(self, cfg):
        ...
        self.reward_model = MixtureRewardModel( reward_models=reward_models,
            ...
            mb_size=cfg.reward_batch,
            large_batch=cfg.large_batch,
            label_margin=cfg.label_margin, logger=self.logger)
...
@hydra.main(config_path='config', config_name='train_PEBBLE_mixture_zero_last_wk_sgd', strict=True)
def main(cfg):
