...
from reward_model.mixture_reward_model_alpha_sum_detach_margin import MixtureRewardModel
...
@hydra.main(config_path='config', config_name='train_PEBBLE_mixture_alpha_sum_log_detach_margin', strict=True)
def main(cfg):
