...
Examples
--------
  python scripts/door_open/run_zero_last_wk_sgd_1,1,1,0.py --dry-run
  python scripts/door_open/run_zero_last_wk_sgd_1,1,1,0.py --device cuda
  python scripts/door_open/run_zero_last_wk_sgd_1,1,1,0.py --seeds 12345 23451
"""
