...
Examples
--------
  python scripts/sweep_into/run_zero_last_wk_sgd_1,1,1,-1.py --dry-run
  python scripts/sweep_into/run_zero_last_wk_sgd_1,1,1,-1.py --device cuda
  python scripts/sweep_into/run_zero_last_wk_sgd_1,1,1,-1.py --seeds 12345 23451
"""
...
def main() -> int:
    args = parse_args()
    print("Zero-last / w_k + SGD TTP — metaworld_sweep-into-v2  β=[1,1,1,-1]")
