...
class RewardModel:
    ...
    def r_hat_batch_grad(self, x):
        ...
        return torch.mean(r_hats, axis=0)  # (n_env, 1, 1)
    ...
    def put_queries(self, sa_t_1, sa_t_2, labels, GT_labels):
        ...
        if next_index >= self.capacity:
            ...
            np.copyto(self.buffer_GT_label[self.buffer_index:self.capacity], GT_labels[:maximum_index])
            ...
            if remain > 0:
                ...
                np.copyto(self.buffer_GT_label[0:remain], GT_labels[maximum_index:])
            ...
            np.copyto(self.buffer_GT_label[self.buffer_index:next_index], GT_labels)
    ...
    def get_label(self, sa_t_1, sa_t_2, r_t_1, r_t_2):
        ...
        if self.teacher_beta != RATIONAL_TEACHER: # Bradley-Terry rational model
        ...
        self.mistake_labels += noise_index.sum()
    ...
    def uniform_sampling_with_human_labeller(self):
        ...
        # get GT labels
        sa_t_1, sa_t_2, r_t_1, r_t_2, _, GT_labels = self.get_label(
            sa_t_1, sa_t_2, r_t_1, r_t_2)
