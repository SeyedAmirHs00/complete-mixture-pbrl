...
Architecture (PEBBLE reward head):
    d_in -> Linear(128) -> LeakyReLU -> Linear(128) -> LeakyReLU
         -> Linear(128) -> LeakyReLU -> Linear(1) -> Tanh
...
def build_reward_mlp(d_in: int, hidden: int = 128, n_hidden: int = 3) -> nn.Sequential:
...
def parse_args() -> argparse.Namespace:
    ...
    p.add_argument("--n_hidden", type=int, default=3, help="Number of Linear->LReLU hidden blocks")
